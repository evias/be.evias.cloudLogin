    ...
    extends AccountAuthenticatorActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (mAuthTokenType == null)
            mAuthTokenType = AccountBase.AUTHTOKEN_TYPE_FULL_ACCESS;
    ...
    public void submit()
    {
        ...
        final String accountType = AccountBase.ACCOUNT_TYPE;
        ...
        new AsyncTask<String, Void, Intent>()
        {
            ...
            protected Intent doInBackground(String... params)
            {
                ...
                try {
                    authtoken = sServerAuthenticate.userSignIn(mContext, userName, userPass, mAuthTokenType);
    ...
    {
        Log.d("cloudLogin", TAG + "> finishLogin");
        ...
        if (getIntent().getBooleanExtra(ARG_IS_ADDING_NEW_ACCOUNT, false)) {
            Log.d("cloudLogin", TAG + "> finishLogin > addAccountExplicitly");
            ...
            Log.d("cloudLogin", TAG + "> finishLogin > setPassword");
